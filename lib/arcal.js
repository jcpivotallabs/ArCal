(function ($) {
  ...
  function fireOnChange(day1, day2) {
    var rangeSelectedEventObject = {};
    if(day1 && new Date(day1.replace(/-/g, '/')) > new Date(day2.replace(/-/g, '/'))) {
      rangeSelectedEventObject.start = day2;
      rangeSelectedEventObject.end = day1;
    } else {
      rangeSelectedEventObject.start = day1;
      rangeSelectedEventObject.end = day2;
    }
